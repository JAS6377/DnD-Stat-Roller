...
# Added sixth stat because D&D does indeed have six stats. Who would have thought?
...
stat6 = statoutput[rolls*5:rolls*6]
...
print("Stat 6 total is ", s6, ", and the bonus is +", s6x)
